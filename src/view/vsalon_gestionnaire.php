...
<body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse d-md-flex justify-content-md-end" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="salon_profile.php?id_salon=<?=$salon->getId_salon()?>" style="font-family: 'DM Serif Display', serif;">Infos salon</a>
                  </li>
                  <li class="nav-item">
    ...
    <main>
      ...
      <div class="container mt-5 d-flex">
        <div class="col-md-8">
        <form method="post" action="salon_gestionnaire.php" class="container-fluid row border border-success-subtle">
