        ...
        <di class="container-fluid row mx-auto">
            <div class="col-md-8 mx-auto d-block">
                ...
                <div class="col-12 d-flex justify-content-center">
                    <a href="salon_application.php"><button id="insSalon" type="submit" class="btn btn-lg fs-2" style="background-color: #FF5B76; color: white;">Inscrire mon salon <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
