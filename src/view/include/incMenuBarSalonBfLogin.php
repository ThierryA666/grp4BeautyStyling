            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse d-md-flex justify-content-md-end" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link disabled" href="<?=APP_ROOT.'/salon/top'?>"style="font-family: 'DM Serif Display', serif;">Inscrire mon salon</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?=APP_ROOT.'/salon/login'?>"style="font-family: 'DM Serif Display', serif;">Se coonecter (Compte salon)</a>
                  </li>
